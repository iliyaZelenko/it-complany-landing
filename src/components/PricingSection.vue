      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h2 class="text-h2 text-center pt-2 mt-15 mb-4">
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-h5 my-2">Time & Material</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Long-term project</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Undefined budget</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Full control over the project</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">No clear requirements</div>
                    <v-divider class="my-2"/>
                    <v-btn
                        v-bind="size"
                        rounded
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-h5 my-2">Fixed Price</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Short-term project</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Modest budget</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Minor changes possible</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Strict scope schedule</div>
                    <v-divider class="my-2"/>
                    <v-btn
                        v-bind="size"
                        rounded
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-h5 my-2">Monthly Salary + Fee</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Any project length</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Well-estimated projects</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Direct management</div>
                    <v-divider class="my-2"/>
                    <div class="blue--text">Full-time engagement</div>
                    <v-divider class="my-2"/>
                    <v-btn
                        v-bind="size"
                        rounded
